...
def information():
    Label(window,text=str(e1.get())).grid(row=9,column=0)
    Label(window,text=str(e2.get())).grid(row=10,column=0)
    Label(window,text=str(e3.get())).grid(row=11,column=0)
    Label(window,text=str(e4.get())).grid(row=12,column=0)
    Label(window,text=str(var.get())).grid(row=13,column=0)
    Label(window,text=str(cvar1.get())).grid(row=14,column=0)
    Label(window,text=str(cvar2.get())).grid(row=14,column=1)
    Label(window,text=str(combo.get())).grid(row=15,column=0)
