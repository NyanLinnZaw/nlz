...
def information():
    result_e1.insert(0,str(e1.get()))
    result_e2.insert(0,str(e2.get()))
    result_e3.insert(0,str(e3.get()))
    result_e4.insert(0,str(e4.get()))

def clear():
    result_e1.delete(0,END)
    result_e2.delete(0,END)
    result_e3.delete(0,END)
    result_e4.delete(0,END)
...
Button(window,text="Show info",width=20,command=information).grid(row=8,column=1,columnspan=2)

result_e1 = Entry(window,width=30)
result_e1.grid(row=9,column=1,columnspan=2)
result_e2 = Entry(window,width=30)
result_e2.grid(row=10,column=1,columnspan=2)
result_e3 = Entry(window,width=30)
result_e3.grid(row=11,column=1,columnspan=2)
result_e4 = Entry(window,width=30)
result_e4.grid(row=12,column=1,columnspan=2)

Button(window,text="Clear",width=20,command=clear).grid(row=13,column=1,columnspan=2)
Button(window,text="Exit",width=20,command=exit).grid(row=14,column=1,columnspan=2)
